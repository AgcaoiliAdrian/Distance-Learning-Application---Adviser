...
$sql = "select * from user_details INNER JOIN application ON user_details.user_id = application.user_id where status = 'approved' ; ";
           ...
           <?php 
            ...
            ?>
              ...
              <tr>
                ...
                <td>
                  <a href="./view-approved-details.php?id=<?php echo $row['user_id']; ?>" uk-toggle>
                      <i
